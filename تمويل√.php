<?php
ob_start();
define('API_KEY','5497434874:AAHYlznxe6vTt26HL57ybqhtgM1C4dWjc2k');
...
$Dev = array("5372193406","5320257704","3");
$usernamebot = "AddMembrTele_bot";
$channel = "Add_Membertle";
$admin = 5372193406;
$channelcode = "1224025095"; // ايدي القناة الي ترسل بيها لهدايا
$token = API_KEY;
...
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
[اضغط هنا وتابع جديدنا ، 📢](https://t.me/Add_Membertle)",
'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
...
- اذا قمت بقراءة جميع النقاط اضغط على زر موافق على الشروط في الاسفل ؛ 🔰 !",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				   [
				   ['text'=>"موافق على الشروط '",'callback_data'=>"takecoin"],['text'=>"• العودة ، 🔙 '",'callback_data'=>'panel']
				   ],
[
				   ],
                     ]
